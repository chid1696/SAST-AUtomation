 ...
 options = (function() {
    ...
    eChartOptions["Timeline"] = {
     ...
     eChartOptions["Scatter"] = {
      ...
      eChartOptions["Pie"] = {
          ...
          series: { name:'', type:'pie', radius : '35%', center: ['50%', '50%'], data:[]}
      }; //pie
      eChartOptions["Donut"] = {
    ...
    var toolboxBasic =  {
        ...
        feature: {
            ...
            dataZoom: {show: false,title: {dataZoom: 'Zoom',dataZoomReset: 'Reset'}}, //dataZoom
            dataView : tableDataView,
            restore: {show: false,title: 'Restore'},
            saveAsImage: {show: true,title: 'save',name:'rxdsCharts'}
         } // feature
       }; // toolboxBasic
       ...
       toolboxPie.feature.dataView = pieDataView;

       toolboxPie.feature.magicType = {
                show: true,
                type: ['pie', 'funnel'],
                option: {
                    funnel: {
