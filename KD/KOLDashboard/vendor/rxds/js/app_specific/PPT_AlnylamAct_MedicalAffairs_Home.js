...
function generate_ppt(include_data) {
  console.log("Executing Page specific powerpoint download function from " + rxds.vendor + "rxds/js/PPT_AlnylamAct_MedicalAffairs_Home.js");
